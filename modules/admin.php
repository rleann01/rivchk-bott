...
////////////====[MUTE]====////////////
if(strpos($message, "/mute ") === 0 and $userId == $config['1534167799']){
...
////////////====[UNMUTE]====////////////
if(strpos($message, "/unmute ") === 0 and $userId == $config['1534167799']){
...
////////////====[BAN]====////////////
if(strpos($message, "/ban ") === 0 and $userId == $config['1534167799']){
...
////////////====[UNBAN]====////////////
if(strpos($message, "/unban ") === 0 and $userId == $config['1534167799']){
...
////////////====[HELPER]====////////////
if(strpos($message, "/admin") === 0 and $userId == $config['1534167799']){
  bot('sendmessage',[
      'chat_id'=>$chat_id,
...
////////////====[BANLIST]====////////////
if(strpos($message, "/banlist") === 0 and $userId == $config['1534167799']){
   $banlist = fetchBanlist();
    ...
    $gettheuserfile = file_get_contents('Banned.txt');
	  ...
	  $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot'.$config['2019365845:AAF0pHuGe5rRU8-9eCPohhO0dqGnFcX-C60'].'/sendDocument');
...
////////////====[MUTELIST]====////////////
if(strpos($message, "/mutelist") === 0 and $userId == $config['1534167799']){
...
////////////====[STATS]====////////////
if(strpos($message, "/userstats ") === 0 and $userId == $config['1534167799']){
...
if(strpos($message, "/botstats") === 0 and $userId == $config['1534167799']){
